    ...
    >
      ...
      <Container onSubmit={handleCreateNewTransaction}>
        ...
        <input
          ...
          placeholder='Valor'
          value={value}
          onChange={event => setValue(Number(event.target.value))} //o event.target.value sempre retorna uma string, mesmo o tipo do input sendo number, então precisamos converter
        />
